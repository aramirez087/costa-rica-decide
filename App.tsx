  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans selection:bg-blue-100">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-white/80 border-b border-gray-200">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          {view === 'voting' && (
             ...
             className="text-sm font-medium text-gray-500 hover:text-blue-800 transition-colors flex items-center space-x-1"
           >
             <BarChart2 size={16} />
      ...
      <footer className="py-8 text-center text-gray-400 text-sm border-t border-gray-200 mt-10">
        <p>© 2024 Costa Rica Decide. Proyecto independiente de demostración.</p>
      </footer>
    </div>
  );
}
